...
resource "aws_route53_record" "acme_challenge_usdigitalregistry_digitalgov_gov" {
  ...
  type    = "CNAME"
  ttl     = 300
  records = ["_acme-challenge.Susdigitalregistry.digitalgov.gov.external-domains-production.cloud.gov."]
}

# U.S. Digital Registry (www)
# www.usdigitalregistry.digitalgov.gov
resource "aws_route53_record" "acme_challenge_www_usdigitalregistry_digitalgov_gov" {
  zone_id = aws_route53_zone.digitalgov_gov_zone.zone_id
